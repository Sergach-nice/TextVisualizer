...
public:
    ...
    bool ConvertVideo(const char* VideoPath, const char* OutputVideoName, sf::RenderWindow &wnd, unsigned block_size, unsigned text_size, sf::Color BackGround, sf::Color TextColor, const char* c_set);
    ///(vis::status)
    int GetStatus();
    /// Saves result of visualization i "RTF"
    bool Visualization(const char* VideoPath, sf::RenderWindow &wnd, unsigned block_size, unsigned text_size, sf::Color BackGround, sf::Color TextColor, const char* c_set);
