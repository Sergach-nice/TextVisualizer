...
public:
    ...
    bool ConvertVideo(const char* VideoPath, const char* OutputVideoName, sf::RenderWindow &wnd, unsigned block_size, unsigned font_size, sf::Color BackGround, sf::Color TextColor, const char* c_set);
    ///(vis::status)
    int GetStatus();
    /// Saves result of visualization i "RTF"
    bool Visualization(const char* VideoPath, sf::RenderWindow &wnd, unsigned block_size, unsigned font_size, sf::Color BackGround, sf::Color TextColor, const char* c_set);
    /// convert RTF to video
    bool toVideo(const char* OutputVideoName, sf::RenderWindow &wnd, unsigned font_size, sf::Color BackGround, sf::Color TextColor);
};
